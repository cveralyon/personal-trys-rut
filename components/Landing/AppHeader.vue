  ...
  <header>
    <nav class="navbar_2">
      <nuxt-link to="/" title="Home">
        <NuxtImg
          src="/icon-rutero.webp"
          alt="rutero-logo-image"
      ...
      <ul class="nav-menu">
        ...
        <li>
          <a @click="goBlogs()" class="nav-link" title="Blogs"> BLOGS </a>
        </li>
      </ul>
          ...
          <li class="dropdown">
            ...
            <div class="dropdown-content" id="user">
              <a href="/login"  class="link"  
                  ...
                  title="Login">Iniciar Sesión</a>
              <a href="/register" class="link" title="Register"> Registrarse </a>
            </div>
          </li>
          <li class="dropdown">
            <button
            ...
            <div class="dropdown-content" id="user_login">
              <a
                href="/admin/services"
                class="link"
                v-if="admin && $auth.user.company_id === 2"
                style="border-bottom: 1px solid lightgray"
              ...
              <a
                :href="'/admin/company/'+$auth.user.company_id+'/Reservas/activas'"
                class="link"
                v-if="admin"
                style="border-bottom: 1px solid lightgray"
              ...
              <a
                :href="'/admin/company/'+$auth.user.company_id+'/Reservas/historial'"
                class="link"
                v-if="admin"
                style="border-bottom: 1px solid lightgray"
...
export default {
  ...
  methods: {
    goBlogs() {
      window.open(`https://www.ruterocamping.com/blog/`, "_blank");
    },
    logout() {
      this.$auth.logout();
      this.$router.push("/");
