<template> 
  <div v-if="reserva" class="grid0">
    <div class="bg-gray-200 rounded-md grid00">
      ...
      <div class="grid3">
        <a type="button" :href="'mailto:'+reserva.email" class="email">
          <NuxtImg format="webp" src="/footer/Email.png" alt="Email-image" title="email" style="max-width:1.5rem;"/>
          Enviar Correo

        </a>
        <a type="button" :href="'tel:'+reserva.phone" class="phone">
          <NuxtImg format="webp"  src="/footer/Phone.png" alt="Phone-image" title="phone" style="max-width:1.5rem;"/>
          +{{ reserva.phone }}
        </a>
        <a type="button" @click="gowsp" class="whatsapp" >WhatsApp</a>
      </div>
    </div>
    <div class="grid2">
      <h6 style="margin-top: auto;">Estado:</h6>
      <div v-if="reserva.status === 1" class="div-pendiente">
        <button disabled class="estadoPendiente" >Pendiente</button>
        <span >¡A la espera de Confirmación!</span>
      </div>
      ...
      <div style="align-self: center;" class="border-t border-gray-300 mt-2 pt-2 flex"></div>
      <button @click="gowspReagendar" class="reagendar" >Reagendar</button>
      <button @click="gowspCancelar" class="cancelarReserva" >Cancelar reserva</button>
      <div><span></span></div>
    </div>
  </div>
