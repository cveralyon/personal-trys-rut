<template>
  <div>
    <img preload  class="imgTerms" src="/Terms/TermPago.jpg" alt="TerminosdePago"/>
    <h1 style="display: none;">Términos de Pago</h1>
    <div class="cuerpo">
      <div class="policy-links">
        <ul>
          ...
          <li><a >Términos de Pago</a></li>
          <li><a href="/PoliticasdeCancelacion">Políticas de Cancelación</a></li>
        </ul>
      </div>
      <div class="terminos">
        <iframe class="iframterms" src="https://docs.google.com/document/d/e/2PACX-1vQR7L7nXjmeITYX6l9oF_Wj58Fff2tEHAHRAWFG_iZyrCzfs4fPjv8XjHFf5_3LQ6CyZ_XJjwed2cXu/pub?embedded=true"></iframe>
      </div>
    </div>
  </div>
</template>
    ...
    return {
      ...
      meta: [
        ...
        },
        {
          hid: "og:url",
          property: "og:url",
          content: "https://www.rutero.cl/TerminosdePago",
        },
      ],
      link: [
        {
          rel: 'canonical',
          href: 'https://www.rutero.cl/TerminosdePago'
        }
      ],
    };
  }
