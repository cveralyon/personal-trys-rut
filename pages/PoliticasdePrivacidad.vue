<template>
  <div>
    <img preload  class="imgTerms" src="/Terms/PolitPrivacidad.jpg" alt="PoliticasdePrivacidad"/>
    <h1 style="display: none;">Políticas de Privacidad</h1>
    <div class="cuerpo">
      ...
      <div class="terminos">
        <iframe class="iframterms" src="https://docs.google.com/document/d/e/2PACX-1vRL9jcjx_Duu21vfZwzlmAqlXnp5dypUEweEtUIgzGI9QnUnEMXNUcQs8M-EcGgvPqG3WsvYDv9YEeC/pub?embedded=true"></iframe>
      </div>
    </div>
  </div>
</template>
...
export default {
  ...
  head() {
    return {
      title: "Rutero |  Políticas de Privacidad",
      meta: [
        {
          hid: "",
          name: "",
        ...
        },
        {
          hid: "og:url",
          property: "og:url",
          content: "https://www.rutero.cl/PoliticasdePrivacidad",
        },
      ],
      link: [
        {
          rel: 'canonical',
          href: 'https://www.rutero.cl/PoliticasdePrivacidad'
        }
      ],
    };
  }
