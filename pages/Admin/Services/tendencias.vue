<template>
    <div v-if="$auth.loggedIn" class="service_grid">
      <h2 class="service-title">Servicios Tendencias</h2>
      <div class="buttons">
  ...
  export default {
    ...
    methods: {
        ...
        await axios
          ...
          .then((response) => {
            if (response.data.data.service == null) {
              ...
              this.creteTendencias();
              this.serviceId = "";
            }}).catch((e) => {
              console.log(e);
            });
      },
      async creteTendencias() {
         // await this.$axios
        await axios.post(`https://rutero-backend-staging.herokuapp.com/api/v1/tendencias_services`,
      ...
      async getTendencias() {
        axios.get(`https://rutero-backend-staging.herokuapp.com/api/v1/tendencias_services`)
          .then((response) => {
            this.services = response.data;
          });
      },
      async deleteService(id) {
        axios.delete(`https://rutero-backend-staging.herokuapp.com/api/v1/tendencias_services/${id}`)
          .then((response) => {
